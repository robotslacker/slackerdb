...
public class PlSqlParserParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, WS=8, CRLF=9, 
		Null=10, Or=11, And=12, Equals=13, NEquals=14, GTEquals=15, LTEquals=16, 
		Pow=17, Excl=18, GT=19, LT=20, Add=21, Subtract=22, Multiply=23, Divide=24, 
		Modulus=25, OBrace=26, CBrace=27, OBracket=28, CBracket=29, OParen=30, 
		CParen=31, SColon=32, Assign=33, Comma=34, QMark=35, Colon=36, DECLARE=37, 
		BEGIN=38, END=39, CURSOR=40, IS=41, LOOP=42, FETCH=43, OPEN=44, LET=45, 
		CLOSE=46, BREAK=47, EXIT=48, WHEN=49, INTO=50, NOTFOUND=51, IF=52, ELSEIF=53, 
		ENDIF=54, THEN=55, FOR=56, TO=57, ELSE=58, RETURN=59, EXCEPTION=60, PASS=61, 
		IN=62, Bool=63, Number=64, Identifier=65, String=66, Comment=67;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "':='", "'INT'", "'TEXT'", "'LONG'", "'DOUBLE'", "'.'", "'%TYPE'", 
			null, "'\\n'", "'null'", "'||'", "'&&'", "'=='", "'!='", "'>='", "'<='", 
			"'^'", "'!'", "'>'", "'<'", "'+'", "'-'", "'*'", "'/'", "'%'", "'{'", 
			"'}'", "'['", "']'", "'('", "')'", "';'", "'='", "','", "'?'", "':'", 
			"'DECLARE'", "'BEGIN'", "'END'", "'CURSOR'", "'IS'", "'LOOP'", "'FETCH'", 
			"'OPEN'", "'LET'", "'CLOSE'", "'BREAK'", "'EXIT'", "'WHEN'", "'INTO'", 
			"'NOTFOUND'", "'IF'", "'ELSEIF'", null, "'THEN'", "'FOR'", "'TO'", "'ELSE'", 
			"'RETURN'", "'EXCEPTION'", "'PASS'", "'in'"
		};
	}
	private static final String[] _LITERAL_NAMES = makeLiteralNames();
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, "WS", "CRLF", "Null", 
	...
	public final Begin_code_blockContext begin_code_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1450159629769113602L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 15L) != 0)) {
				{
				setState(114);
				_errHandler.sync(this);
	...
	public final Loop_blockContext loop_block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1522221621853552642L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 15L) != 0)) {
				{
				{
				setState(190);
				sql_block();
	...
	public final Sql_tokenContext sql_token() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(281);
				_la = _input.LA(1);
				if ( _la <= 0 || ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3833087204477894656L) != 0)) ) {
	...
	public static class DatatypeContext extends ParserRuleContext {
		public List<TerminalNode> Identifier() { return getTokens(PlSqlParserParser.Identifier); }
		public TerminalNode Identifier(int i) {
			return getToken(PlSqlParserParser.Identifier, i);
		}
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 10)) & ~0x3f) == 0 && ((1L << (_la - 10)) & 135107988889538817L) != 0)) {
				{
				setState(366);
				exprList();
				}
