...
import org.slackerdb.jdbc.jdbc.FieldMetadata;
...
public interface BaseConnection extends PGConnection, Connection {
   ...
   * the types registered via {@link PGConnection#addDataType(String, Class)} and
   * {@link PGConnection#addDataType(String, String)}.
   *
   * <p>If no class is registered as handling the given type, then a generic
   * {@link PGobject} instance is returned.</p>
   *
