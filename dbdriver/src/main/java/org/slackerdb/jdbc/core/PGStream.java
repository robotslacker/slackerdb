...
import org.slackerdb.jdbc.gss.GSSInputStream;
import org.slackerdb.jdbc.gss.GSSOutputStream;
import org.slackerdb.jdbc.util.ByteStreamWriter;
import org.slackerdb.jdbc.util.GT;
import org.slackerdb.jdbc.util.HostSpec;
import org.slackerdb.jdbc.util.PGPropertyMaxResultBufferParser;
import org.slackerdb.jdbc.util.PSQLException;
import org.slackerdb.jdbc.util.PSQLState;
import org.slackerdb.jdbc.util.internal.PgBufferedOutputStream;
...
public class PGStream implements Closeable, Flushable {
   ...
   * @deprecated use {@link #PGStream(SocketFactory, HostSpec, int, int)}
   */
  @Deprecated
