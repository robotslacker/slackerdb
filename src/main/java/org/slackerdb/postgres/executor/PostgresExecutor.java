...
import org.slackerdb.postgres.executor.converters.PostgresCallConverter;
import org.slackerdb.postgres.fsm.PostgresProtoContext;
import org.slackerdb.postgres.messages.*;
...
import org.slackerdb.sql.parser.SqlParseResult;
import org.slackerdb.sql.parser.SqlStringParser;
import org.slackerdb.sql.parser.SqlStringType;
...
//        fakeQueries.add("select current_schema()".toLowerCase(Locale.ROOT));
    ...
    private ExecutorResult executeRealQuery(NetworkProtoContext protoContext, Parse parse,
        ...
        try {
            ...
            AppLogger.logger.trace("[SERVER] [EXECUTOR] {}", e.getMessage());
